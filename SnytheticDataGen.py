...
def main():
    ...
    images_path = os.path.join(data_directory, mode+'_ground_truth_training_images') ##sam to change this
    print('images path')
    print(images_path)
    ground_truth_path = os.path.join(data_directory, mode+'_ground_truth_training_data')
